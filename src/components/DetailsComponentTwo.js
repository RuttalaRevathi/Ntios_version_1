  ...
  render() {
    return (
      <View>
        ...
        <View>
          {this.props?.item?.web_featured_image !== false && (
            <Image
              source={{
          ...
          <AutoHeightWebView
            ...
            source={{
              html: (this.props.item.content.rendered +=
                "<style>@import url('https://fonts.googleapis.com/css2?family=Mandali&display=swap');p strong, span, p span{font-family: 'Mandali', sans-serif;}p,li{font-family: 'Mandali', sans-serif;line-height:1.6;color:#000;font-weight:500;font-size:20px}</style>"),
